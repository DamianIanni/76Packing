...
export class ThemeManager {
  ...
  get colors() {
    return {
      ...
      backgroundCard: this.isDarkMode ? "#ffffff" : "#000000",
      button: this.isDarkMode ? "#ffffff" : "#000000",
      text: this.isDarkMode ? "#ffffff" : "#000000", // Color del texto
      textTitle: this.isDarkMode ? "#ffffff" : "#000000", // Color del texto
      textHeader: this.isDarkMode ? "#ffffff" : "#000000", // Color del texto
      text76: "#173B61",
